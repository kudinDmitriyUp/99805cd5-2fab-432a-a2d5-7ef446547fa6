...
export const metadata: Metadata = {
  title: "Vera & Bennet - A Journey Through Grief | Independent Film",
  description: "Experience the powerful story of Vera and Bennet as they navigate grief and discover acceptance. An emotional film about loss, healing, and human resilience.",
  keywords: "grief movie, independent film, emotional drama, loss, acceptance, healing, Vera, Bennet, indie cinema",
  openGraph: {
    title: "Vera & Bennet - A Journey Through Grief",
    description: "A powerful film exploring grief, loss, and the path to acceptance through the stories of two unforgettable characters.",
    siteName: "Vera & Bennet Film",
    type: "website",
    images: [{
      url: "https://webuild-dev.s3.eu-north-1.amazonaws.com/users/user_32T51L3BHE8qqE8rXXWBwMZaYtk/uploaded-1763162898912-glnqpgox.jpg",
  ...
  twitter: {
    ...
    title: "Vera & Bennet - A Journey Through Grief",
    description: "An emotional exploration of grief and acceptance through the stories of Vera and Bennet.",
    images: ["https://webuild-dev.s3.eu-north-1.amazonaws.com/users/user_32T51L3BHE8qqE8rXXWBwMZaYtk/uploaded-1763162898912-glnqpgox.jpg"]
  },
  robots: {
    index: true,
    follow: true
